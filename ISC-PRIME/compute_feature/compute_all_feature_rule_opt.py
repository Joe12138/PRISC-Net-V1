...
from path_generation.opt_quintic_poly import opt_quintic_polynomial_planner
...
def get_candidate_trajs(scene_name: str,
    ...
    for i in range(20):
        ...
        max_speed = init_veh_state["v"]+4 if speed_limit is None else abs(speed_limit)
...
def parse_arguments() -> Any:
    ...
    save_path = f"/home/joe/Desktop/Rule-PRIME/Data/feature_test/frenet_{mode}_opt"
