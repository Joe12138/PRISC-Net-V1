...
def train(gpu, args):
    train_set = InteractionInMem(pjoin(args.data_root, "train_intermediate")).shuffle()
    eval_set = InteractionInMem(pjoin(args.data_root, "val_intermediate"))
    ...
    for iter_epoch in range(args.n_epoch):
        ...
        if not min_eval_loss:
            ...
            trainer.save_target_model("best")

    trainer.save_target_model("final")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_dir", required=False, type=str,
                        default="/home/joe/Desktop/Rule-PRIME/Model/target_more_feature_output",
