...
class TargetPredTrainer(Trainer):
    """
    ...
    def __init__(self,
                 ...
                 ckpt_path: str = None,
                 verbose: bool = True):
        super(TargetPredTrainer, self).__init__(
            trainset=trainset,
            evalset=evalset,
            testset=testset,
    ...
    def test(self):
        ...
        with torch.no_grad():
            for data in tqdm(self.test_loader):
                ...
                for batch_id in range(batch_size):
                    ...
                    real_coord_pred = [self.convert_coord(pred_y_k, origs[batch_id],
                                                          rots[batch_id]) if convert_coordinate else pred_y_k for
                                       pred_y_k in target_pred_se[batch_id]+offset_pred_se[batch_id]]

                    gt_trajectories = self.convert_coord(gt[batch_id], origs[batch_id],
                                                         rots[batch_id]) if convert_coordinate else gt[batch_id]
        ...
        print("min_fde = {}, max_fde = {}, avg_fde = {}".format(min_fde, max_fde, avg_fde/index))
