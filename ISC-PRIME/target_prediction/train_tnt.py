...
from target_prediction.dataloader.interaction_loader_v3 import InteractionInMem as ArgoverseInMemv2, GraphData
from target_prediction.trainer.tnt_trainer import TNTTrainer
...
def train(gpu, args):
    ...
    :return:
    """
    train_set = ArgoverseInMemv2(pjoin(args.data_root, "val_intermediate")).shuffle()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data_root", required=False, type=str, default="/home/joe/Dataset/target_data",
                        help="root dir for datasets")
    parser.add_argument("-o", "--output_dir", required=False, type=str, default="/home/joe/Desktop/Rule-PRIME/Model/tnt_output",
    ...
    parser.add_argument("--lr", type=float, default=0.0012, help="learning rate of adam")
    ...
    parser.add_argument("-ldr", "--lr_decay_rate", type=float, default=0.3, help="lr scheduler decay rate")
