...
class ComparePredictor():
    def __init__(
        ...
        self.args = args
        self.save_dir = os.path.join("/home/joe/Desktop/trained_model", "best_prime_rule_prime_dense_tnt_comparison")
    ...
    def validate(self):
        ...
        with torch.no_grad():
            ...
            for scene_name, case_id, track_id in tqdm(self.target_veh_list):
                ...
                data_dict["densetnt"] = dense_tnt_traj
                ...
                data_dict["prime"] = prime_pred_traj
                ...
                data_dict["rule_prime"] = rule_pred_traj 
                ...
                data_dict["obs_xy"] = obs_xy
                data_dict["gt_xy"] = gt_xy
                ...
                # axes.plot(obs_xy[:, 0], obs_xy[:, 1], color="#FC8C23", linewidth=line_width, label="Obs")
                # axes.scatter(obs_xy[-1, 0], obs_xy[-1, 1], color="#FC8C23", marker="x", s=20)

                # axes.plot(gt_xy[:, 0], gt_xy[:, 1], color="#207F4C", linewidth=line_width, label="GTs")
                # axes.scatter(gt_xy[-1, 0], gt_xy[-1, 1], color="#207F4C", marker="x", s=20)
                ...
                # exit(0)
                with open(os.path.join("/home/joe/Desktop/trained_model/pred_data_opt_v2/pred_data", f"{scene_name}_{case_id}_{track_id}.pkl"), "wb") as f:
...
if __name__ == '__main__':
    ...
    rule_prime_data_path = "/home/joe/Desktop/trained_model/pred_data_opt_v2/frenet_val/split"
    ...
    rule_model_path = "/home/joe/Desktop/trained_model/pred_data_opt_v2/best_opt_traj_20_process_v2/train/model_checkpoint_5.pth"
